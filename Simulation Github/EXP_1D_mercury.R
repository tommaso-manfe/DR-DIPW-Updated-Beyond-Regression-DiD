#EXPERIMENT 1D: NON-RANDOMIZED EXPERIMENT WITH X-SPECIFIC TRENDS
#              PROPENSITY SCORES NOT CORRECTLY SPECIFIED, OUTCOME REGRESSION NOT CORRECTLY SPECIFIED
...
ptime
print(res)
saveRDS(res, "EXP_1D_storage.rds")
